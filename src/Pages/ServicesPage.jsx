...
import main from "../assets/servive_main.png";
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden backdrop-blur-md absolute bg-navbar_bg w-full z-10 bg-opacity-[29%] text-white lg:flex items-center justify-between  px-16">
              ...
              >
                ...
                <div className="grid grid-cols-4 w-fit gap-4 items-center px-4 mt-4">
                  {images.map((image, index) => (
                    <div key={index}>
                      <img className="w-6" src={image} alt={`Social media ${index + 1}`} />
                    </div>
                  ))}
                </div>
              </motion.div>
        ...
        <img className="w-full h-screen object-cover" src={main} alt="Services hero" />
        ...
        {datas.map((data, index) => (
          ...
          >
            ...
            <div className="lg:w-[50%] text-left lg:p-8 mt-2 lg:mt-16 service-text">
              <p className="text-h4-mobile lg:text-h3-desktop font-jost text-choose_bg font-bold">{data.title}</p>
              <p className="font-jost text-body-mobile lg:text-body-desktop text-service_bg mt-2 lg:mt-4">{data.content}</p>
            </div>
          </div>
        ))}
      </div>
