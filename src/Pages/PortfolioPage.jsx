    ...
    <div className="w-full">
      ...
      <div className="w-full">
        <div className="w-full relative">
          ...
          <div className="absolute z-10 w-full flex flex-col items-center top-4 lg:top-10">
            ...
            <div className="w-full flex justify-center items-center gap-4 lg:gap-20 mt-4 lg:mt-10 pb-6 border-b-4 border-white">
              <img
                ...
                alt="Apple Music"
              />
              <img className="w-[100px] lg:w-[200px]" src={tidal} alt="Tidal" />
              <img
                className="w-[100px] lg:w-[200px]"
                src={amazon}
                alt="Amazon Music"
          ...
          <img className="relative h-[500px] lg:h-auto" src={bg1} alt="" />
        </div>
        {/* Bg 2 */}
        <div className="w-full relative">
          <div className="w-full lg:flex h-full py-8 px-4  absolute z-10">
            ...
            <div className="lg:w-[50%] lg:h-full flex flex-col justify-center mt-10 lg:mt-0 lg:gap-16">
              ...
              <button className="m-auto lg:m-0 mt-8 lg:mt-0 bg-white px-10 py-2 text-body-mobile lg:text-body-desktop rounded-[40px] font-jost  w-fit">
                Book a Call
              </button>
            </div>
          </div>
          <img className="lg:h-auto h-[300px]" src={bg2} alt="" />
        </div>
        {/* Speakers */}
        ...
        <div className="w-full flex flex-col py-8 bg-choose_bg">
          <div className="flex">
            <div className="hidden lg:block w-[30%]">
              <img className="h-[550px] mt-80" src={mic} alt="" />
            </div>
                  ...
                  {musics.map((music, index) => (
                    ...
                    >
                      ...
                      <div className="w-1/3 flex gap-2 justify-start items-center">
                        <img className="w-8 lg:w-12" src={sound} alt="Sound" />
          ...
          <div className="w-full flex justify-center pt-10">
            <img className="w-[700px] h-auto" src={speaker_group} alt="" />
          </div>
        </div>
      </div>
      <Suspense>
