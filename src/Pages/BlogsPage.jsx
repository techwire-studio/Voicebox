...
const items = [
	{
		...
		content:
			"See The Various Equipment In Recording Studio kitpro September 30, 2024…",
	},
	{
		image: img2,
					...
					<div
						...
						<div className="px-4 py-8 bg-service_bg rounded-b-[15px]">
							...
							<button
								...
								className="m-auto lg:m-0 flex bg-white text-service_bg px-6 py-2 rounded-[20px] mt-4 lg:mt-6">
								Know More
							</button>
						</div>
					</div>
