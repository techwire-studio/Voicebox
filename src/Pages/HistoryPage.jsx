  ...
  useEffect(() => {
    if (isClient) {
      ...
      if (desktopTimelineRef.current) {
        const timelineItems = desktopTimelineRef.current.querySelectorAll('.timeline-item');
  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden backdrop-blur-md absolute bg-navbar_bg w-full z-10 bg-opacity-[29%] text-white lg:flex items-center justify-between  px-16">
        ...
        <img className="w-full h-screen object-cover" src={main1} alt="" />
        ...
        <button ref={buttonRef} className="absolute w-fit top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  z-10 px-8 mt-28 rounded-[20px] py-3 text-body-mobile bg-service_heading text-white  font-jost">
            Know more
          </button>
      </div>
      <div className="relative flex justify-center">
        <div ref={paraRef} className="lg:right-28 -translate-y-1/2 top-1/2 absolute  w-[90%] lg:w-[40%] font-jost text-white font-semibold text-body-mobile lg:text-body-desktop bg-black bg-opacity-[70%] rounded-[15px] text-left px-4 py-8">
          <p>
        ...
        <img className="h-[600px] w-full object-cover" src={main2} alt="" />
      </div>
      {/* Content */}
      ...
      {/* TimeLine - Desktop */}
      <div ref={desktopTimelineRef} className="hidden lg:block relative w-full px-16 mt-10">
