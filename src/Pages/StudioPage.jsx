...
const StudioPage = () => {
  ...
  useEffect(() => {
    if (isClient && infoSectionRef.current) {
      ...
      infoTl.from(infoSectionRef.current, {
        opacity: 0,
        scale: 0.95,
        duration: 0.8,
        ease: "power2.out"
      ...
      .from(infoTitleRef.current, {
        opacity: 0,
        y: 30,
        duration: 0.6,
        ease: "power3.out"
      }, "-=0.3")
      .from(infoTextRef.current, {
        opacity: 0,
        y: 20,
        duration: 0.6,
        ease: "power3.out"
    ...
    <div className="w-full">
      ...
      >
        {images.map((image, index) => (
          ...
          >
            <img className="lg:h-[500px]" src={image.image} alt="" />
