...
const images = [img24, img25,img1, img2, img3, img4,img5,img6,img7,img8,img9,img10,img11,img12,img13,img14,img15,img16,img17,img18,img19,img21,img22,img23];
...
const Gallery = () => {
  ...
  return (
    <div className="w-full lg:py-8 py-4 px-4 lg:px-4 flex flex-col justify-center items-center">
      ...
      <div ref={swiperRef} className="w-full mt-4 lg:mt-8">
        <Swiper
          modules={[Pagination]}
          className="mySwiper"
          breakpoints={{
        ...
        >
          {images.map((image, index) => (
            <SwiperSlide className="" key={index}>
              <img className="rounded-[15px] h-[200px] lg:h-[550px] w-full object-fill" src={image} alt="" />
            </SwiperSlide>
          ))}
        </Swiper>
      </div>
