...
import gmail from "../assets/email_footer.webp";
import mobile from "../assets/phone-call_footer.webp";
import gps from "../assets/gps_footer.webp";
					...
					<ul
						...
						<li className="flex gap-4  text-subtext-mobile lg:text-subtext-desktop">
							<img
								...
								loading="lazy"
							/>
							Street Address: #1681, Shree Sai Tulip Street Address Line 2: 4th
							cross, 8th main, HAL 3rd stage, New Thippasandra City: Banglore
							State / Province: Karnataka Postal / Zip Code: 560075
						</li>
					</ul>
				</div>
				<div
