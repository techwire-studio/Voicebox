...
const Studio = () => {
  ...
  return (
    <div className="w-full py-8 px-8 flex flex-col justify-center items-center bg-service_bg">
      ...
      Visit our modern studio branch featuring advanced equipment, dedicated expert support, and exceptional recording environments.
      </p>
      {/* Gallery */}
      ...
      {/* Galley Mobile */}
      <div ref={galleryRef} className="lg:hidden w-full flex flex-col gap-4 mt-8">
      {/* Div 1 */}
      <div ref={div1Ref} className="w-full h-[600px] flex gap-4">
        <div className="h-full w-1/2 space-y-4">
          <div className="gallery-item relative w-full h-2/3">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Live Sound <br /> Recording</p>
          </div>
          <div className="gallery-item w-full h-1/3 relative">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Multi-Track <br /> Recording</p>
          </div>
        </div>
        <div className="h-full w-1/2 space-y-4">
          <div className="gallery-item w-full h-1/3 relative flex justify-center items-center">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 text-center">The Studio Experience We Provide</p>
          </div>
          <div className="gallery-item w-full h-2/3 relative">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Music Studio </p>
          </div>
        </div>
      </div>
      
      {/* Div 2 */}
      <div ref={div2Ref} className="w-full h-[400px] flex gap-4 mt-4">
        <div className="gallery-item h-full w-1/2 relative">
          ...
          <img
            ...
            alt=""
          />
          <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Binaural Recording</p>
        </div>
        <div className="h-full w-1/2 flex flex-col gap-4">
          <div className="gallery-item w-full h-1/2 relative">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Mastering Studio </p>
          </div>
          <div className="gallery-item w-full h-1/2 relative">
            <div className="absolute w-full h-full z-10 bg-black bg-opacity-[50%] rounded-[15px]"></div>
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Electronic 
              Recordings</p>
          </div>
        </div>
      </div>
      ...
      {/* Div 3 */}
      <div ref={div3Ref} className="w-full h-[400px] space-y-4">
        <div className="gallery-item w-full h-1/2 relative">
          <div className="absolute w-full h-full z-10 bg-black bg-opacity-[50%] rounded-[15px]"></div>
          <img
            ...
            alt=""
          />
          <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Overdubbing <br /> Studio </p>
        </div>
        <div className="w-full h-1/2 flex gap-4">
          <div className="gallery-item h-full w-1/2 relative">
            ...
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Sound Recording Studio </p>
          </div>
          <div className="gallery-item h-full w-1/2 relative">
            <div className="absolute w-full h-full z-10 bg-black bg-opacity-[50%] rounded-[15px]"></div>
            <img
              ...
              alt=""
            />
            <p className="absolute text-white font-jost text-h2-mobile z-20 bottom-8 left-2">Acoustic Recordings Studio </p>
          </div>
        </div>
      </div>
    </div>
